...
import com.example.kuispemrogramanmobile.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void moveSms(View view) {
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("call:" + "0811405501")).putExtra("call_body", "Hai nama saya Irene"));
    }
